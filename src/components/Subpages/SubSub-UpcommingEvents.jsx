...
const PastEvents = () => {
  const {
    ...
    isError,
    isLoading,
  } = API("https://localhost:7296/get-all-upcomming-events-company-page");
  ...
  return (
    <>
      ...
      <div className="Info">
        ...
        {isLoading && <p className="loading">Laddar kommande event...</p>}
        {isError && <p className="error">Inga kommande event hittades.</p>}
        {events.map(
          (
